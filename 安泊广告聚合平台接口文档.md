...
新版接口  
<font color=blue size=2>[PUT]</font> *https://<font color=blue>api</font>-test.anbokeji.net/api/v2/advert-pos*
...
| parkId             | 车场ID       | String   | 16       | 必填     |                                              |
| status             | 状态         | String   | 1        | 必填     | StatusEnum：  0：停用，1：启用 <br/> <font color=red>使用新版接口v2,请不要上传该字段</font>              |
| sign               | 签名         | String   | 64       | 必填     | ECC签名，根据SDK和密钥生成                   |
...
| content       | 广告内容 | String   |          |          |                                          |
| adId          | 广告ID   | String   |          |          |                                          |
| adType        | 广告形式 | String   |          |          | 枚举AdTypeEnum：0：文字链接，1：图文链接 2: 页面直跳 3: 微信小程序 |
...
<font color=blue size=2>[POST]</font>  <font color=blue>***https://api-test.anbokeji.net***</font>*/api/v1/data/save*
...
| parkId             | 车场ID   | String   | 16       | 必填     |          |
| partnerId        | 流量主ID | String   | 10       | 必填     | 唯一值   |
| vehicleNum             |  用户车牌号  | String   | 16       | 必填     |          |
| imageContent         | 图片数据 | String   | --        | 必填     |   base64编码       |
| imageName        | 图片名称 | String   | 16        | 必填     |          |
| imgTime        | 拍照时间 | String   | 16        | 非必填     |     yyyyMMddhhmmss     |
| mobile        | 手机号 | String   | 16        | 非必填     |          |
| lng        | 经度 | String   | 16        | 非必填     |          |
| lat        | 维度 | String   | 16        | 非必填     |          |
| ip        | 用户ip | String   | 16        | 非必填     |          |
