...
| status             | 车场状态 | String   | 1        | 非必填   | 枚举StatusEnum：(默认1)  0：停用，1：启用 <br/> <font color=red>使用新版接口v2 请忽略该字段</font>|
| partnerId          | 流量主ID | String   | 10       | 必填     |                                           |
| sign               | 签名     | String   | 64       | 必填     | ECC签名，根据SDK和密钥生成                |
...
| status             | 车场状态 | String   | 1        | 非必填   | 枚举StatusEnum：  0：停用，1：启用 <br/> <font color=red>使用新版接口v2 请忽略该字段</font>|
| partnerId          | 流量主ID | String   | 10       | 必填     |                                |
...
| parkId             | 车场ID       | String   | 16       | 必填     |                                              |
| status             | 状态         | String   | 1        | 必填     | StatusEnum：  0：停用，1：启用 <br/> <font color=red>使用新版接口v2 请忽略该字段</font>              |
| sign               | 签名         | String   | 64       | 必填     | ECC签名，根据SDK和密钥生成                   |
